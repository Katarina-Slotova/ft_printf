...
/*   Updated: 2022/02/21 17:52:07 by katarinka        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_u_width(char *print_num, int check_num, char *flags, int width)
{
	char	*final_num;
	int		empty_spaces;
...
char	*ft_u_precision(char *print_num, char *flags, int precision)
{
	char	*final_num;
	int		zeroed_spaces;

	if (ft_strlen(print_num) < precision)
	{
